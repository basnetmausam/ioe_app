...
Widget buildSheet1(BuildContext context, SheetState state) => Material(
      child: Padding(
...
Widget buildSheet2(BuildContext context, SheetState state) => Material(
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          mainAxisSize: MainAxisSize.min,
...
Widget buildSheet3(BuildContext context, SheetState state) => Material(
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          mainAxisSize: MainAxisSize.min,
...
Widget buildSheet4(BuildContext context, SheetState state) => Material(
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          mainAxisSize: MainAxisSize.min,
...
Widget buildSheet5(BuildContext context, SheetState state) => Material(
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          mainAxisSize: MainAxisSize.min,
...
Widget buildSheet6(BuildContext context, SheetState state) => Material(
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          mainAxisSize: MainAxisSize.min,
...
Widget buildSheet7(BuildContext context, SheetState state) => Material(
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          mainAxisSize: MainAxisSize.min,
...
Widget buildSheet8(BuildContext context, SheetState state) => Material(
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          mainAxisSize: MainAxisSize.min,
...
Widget buildSheet9(BuildContext context, SheetState state) => Material(
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          mainAxisSize: MainAxisSize.min,
...
Widget buildSheet10(BuildContext context, SheetState state) => Material(
      child: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          mainAxisSize: MainAxisSize.min,
