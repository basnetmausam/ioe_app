        ...
        children: [
          ...
          Padding(
            ...
            child: RichText(
              ...
              TextSpan(
                text:
                    "Click Here for BE/BArch Entrance Examination Syllabus of 2078 BS",
                style: const TextStyle(
                  color: Colors.blue,
                ),
                recognizer: TapGestureRecognizer()
                  ..onTap = () => launch(
                      'https://ioe.edu.np/media/1691/be_barch-syllabus-2078.pdf'),
              ),
            ])),
          ),
          Padding(
          ...
          Padding(
            ...
            child: RichText(
                text: TextSpan(children: [
              TextSpan(
                text: "Click Here For BE/BArch Booklet 2078",
                style: const TextStyle(
                  color: Colors.blue,
                ),
                recognizer: TapGestureRecognizer()
                  ..onTap = () => launch(
                      'https://ioe.edu.np/media/1690/ioe_be_barch-booklet-2078.pdf'),
              ),
            ])),
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text(
              "IOE bachelor programs are available on all of its constituent campuses and the affiliated colleges while the masters programs are available only at its constituent campuses: Pulchowk Campus, Thapathali Campus, Purwanchal Campus and Pashchimanchal Campus .\n\nThe following are the graduate course available in IOE :\n",
              textAlign: TextAlign.justify,
              style: Theme.of(context).textTheme.bodyText2,
            ),
          ),
