...
Widget InfraStructCard(BuildContext context) {
  return Card(
      child: ListTile(
          ...
          return ListView(
            children: [
              ...
              ClipRRect(
                ...
                child: Image.asset('assets/images/msinfra.png'),
              ),

              Padding(
                padding: const EdgeInsets.all(16.0),
                child: Text(
                  'Institute of Engineering (IOE) Pulchowk Campus enrolls 20 students each year in Master of Science (M.Sc) in Infrastructure Engineering & Management.\n',
    ...
    title: const Text('M.SC. IN INFRASTRUCTURE ENGINEERING & MANAGEMENT'),
  ));
}
