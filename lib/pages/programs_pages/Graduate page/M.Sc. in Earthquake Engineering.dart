...
Widget EarthQCard(BuildContext context) {
  return Card(
      child: ListTile(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: Image.asset('assets/images/msearthQ.png'),
                    ),

                    Padding(
                      padding: const EdgeInsets.all(16.0),
                      child: Text(
                        'Institute of Engineering (IOE) Pulchowk Campus enrolls 20 students each year in Master of Science (M.Sc) in EARTHQUAKE ENGINEERING.\n',
    ...
    title: const Text('M.SC. IN EARTHQUAKE ENGINEERING'),
  ));
}
