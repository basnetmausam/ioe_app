...
Widget CompSstemAndKnowledgeCard(BuildContext context) {
  return Card(
      child: ListTile(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: Image.asset('assets/images/mscompsys.png'),
                    ),
    ...
    title: const Text('M.SC. IN COMPUTER SYSTEM AND KNOWLEDGE ENGINEERING'),
  ));
}
